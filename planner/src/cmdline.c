...
const char *gengetopt_args_info_help[] = {
  ...
  "      --config=INT              select a configuration",
  "  -o, --output=STRING           output plan file",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->heuristic_help = gengetopt_args_info_help[10] ;
  args_info->heuristic_min = 0;
  args_info->heuristic_max = 0;
  args_info->mainHeuristicAsTiebreaker_help = gengetopt_args_info_help[11] ;
  args_info->astarweight_help = gengetopt_args_info_help[12] ;
  args_info->gValue_help = gengetopt_args_info_help[13] ;
  args_info->suboptimal_help = gengetopt_args_info_help[14] ;
  args_info->noVisitedList_help = gengetopt_args_info_help[17] ;
  args_info->noTaskHash_help = gengetopt_args_info_help[18] ;
  args_info->noTaskSequenceHash_help = gengetopt_args_info_help[19] ;
  args_info->noTopologicalOrdering_help = gengetopt_args_info_help[20] ;
  args_info->noLayers_help = gengetopt_args_info_help[21] ;
  args_info->noOrderPairs_help = gengetopt_args_info_help[22] ;
  args_info->noParallelSequences_help = gengetopt_args_info_help[23] ;
  args_info->noGIcheck_help = gengetopt_args_info_help[24] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hdS:t:No:H:w:g:VTQO", long_options, &option_index);
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "config") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->config_arg), 
                ...
                &(local_args_info.config_given), optarg, 0, 0, ARG_INT,
                check_ambiguity, override, 0, 0,
                "config", '-',
                additional_error))
              goto failure;
