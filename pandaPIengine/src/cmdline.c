...
const char *gengetopt_args_info_help[] = {
  ...
  "      --optimality              optimally planning  (default=off)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->optimality_help = gengetopt_args_info_help[36] ;
  args_info->methodPreconditionsInSeparateLeafs_help = gengetopt_args_info_help[37] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->optimality_given)
    write_into_file(outfile, "optimality", 0, 0 );
...
.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          /* optimally planning.  */
          else if (strcmp (long_options[option_index].name, "optimality") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->optimality_flag), 0, &(args_info->optimality_given),
                &(local_args_info.optimality_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "optimality", '-',
                additional_error))
              goto failure;
