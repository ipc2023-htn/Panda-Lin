...
struct gengetopt_args_info
{
 ...
 help description.  */
  ...
  int optimality_flag;	/**< @brief optimally planning (default=off).  */
  const char *optimality_help; /**< @brief optimally planning help description.  */
  ...
  unsigned int optimality_given ;	/**< @brief Whether optimality was given.  */
